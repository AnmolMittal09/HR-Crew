    ...
    <div className="bg-gray-900 text-white relative">
          ...
          <div className="space-x-6 hidden md:flex">
            {["home", "about", "artists", "contact"].map((item) => (
              <button
                ...
                className={`${
                  activeSection === item ? "text-cyan-400 border-b-2 border-cyan-400" : "text-gray-400"
                } uppercase`}
              >
                {item}
              </button>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div className="relative text-center z-40" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
          <h1 className="text-6xl font-bold">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-500">HR CREW</span>
            <br /> MUSIC STUDIO
          </h1>
      ...
      <section id="contact" className="py-20 bg-gray-800 text-center">
        ...
        <div className="space-y-4">
          <p className="flex items-center justify-center"><MapPin className="mr-2" /> 123 Music Avenue</p>
          <p className="flex items-center justify-center"><Phone className="mr-2" /> +1 555 123456</p>
          <p className="flex items-center justify-center"><Mail className="mr-2" /> info@hrcrew.com</p>
        </div>
      </section>
    </div>
  );
